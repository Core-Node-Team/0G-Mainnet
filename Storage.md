...
User=root
WorkingDirectory=$HOME/0g-storage-node/run
ExecStart=$HOME/0g-storage-node/target/release/zgs_node --config config-testnet-turbo.toml --miner-key Private-key-yaz --blockchain-rpc-endpoint https://evmrpc.0g.ai
Restart=on-failure
RestartSec=10
LimitNOFILE=65535
